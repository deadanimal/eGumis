    ...
    <body>
        ...
        <main class="main" id="top">
            <div class="container-fluid">
                ...
                <div class="container-fluid">
                    <div id="fade-in" style="background: url('../../../assets/img/bg-4.png');-webkit-background-size: cover;
                    -moz-background-size: cover;
                    -o-background-size: cover;
                    background-size: cover;">
                                                ...
                                                <div class="p-4 p-md-5 flex-grow-1">
                                                    <div class="row flex-between-center">
                                                        <div class="text-center fade-in" style="filter: drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25));">
                                                            <img class="fade-in" src="/assets/img/IOS-eGUMIS_1024px_1.svg" alt="EGUMIS" style="width: 142px; height:142px">
                                                        </div>
                                                        <div class="col mb-3">
